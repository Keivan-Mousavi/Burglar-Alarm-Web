...
using BurglarAlarmWebML.Model;

namespace BurglarAlarmWebML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Source\BurglarAlarmWeb\BurglarAlarm.Web\ML\yelp_labelled.txt";
